...
public class TentangKami extends  FragmentActivity implements OnMapReadyCallback {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent backyuk = new Intent(TentangKami.this, Dashboard.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent backyuk2 = new Intent(TentangKami.this, Dashboard.class);
        ...
        Datareff.addValueEventListener(new ValueEventListener() {
            ...
            FotoTentangKami fotoTentangKami = dataSnapshot.getValue(FotoTentangKami.class);
