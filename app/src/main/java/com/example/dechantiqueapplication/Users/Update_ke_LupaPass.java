...
public class Update_ke_LupaPass extends AppCompatActivity {

    FirebaseAuth firebaseAuth;
    private Button Lupapass_;
    private EditText EmailLupa;
    private ImageView back;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_update_ke__lupa_pass);

        firebaseAuth = FirebaseAuth.getInstance();
        Lupapass_ = findViewById(R.id.lupapass);
        EmailLupa = findViewById(R.id.etEmaillupa);
        back = findViewById(R.id.bakKeProfile_act_);

        Lupapass_.setOnClickListener(new View.OnClickListener() {
            @Override
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()){
                                    Toast.makeText(Update_ke_LupaPass.this,
